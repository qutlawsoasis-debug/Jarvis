...
voice_id = "cPoqAvGWCPfCfyPMwe4z" # Kallixis

text = "Привет! Я Калликсис, твой новый голосовой ассистент. Системы работают штатно, качество звука превосходное."
...
try:
    print("Отправка запроса в ElevenLabs (Калликсис)...")
    response = requests.post(url, json=payload, headers=headers, timeout=20)
    print("Статус-код:", response.status_code)
    if response.status_code == 200:
        filename = "test_kallixis.mp3"
